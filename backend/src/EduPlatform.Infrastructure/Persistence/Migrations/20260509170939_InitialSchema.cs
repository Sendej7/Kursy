        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    LastActiveDay = table.Column<DateTime>(type: "timestamp with time zone", nullable: true),
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    PriceMonthlyPln = table.Column<decimal>(type: "numeric", nullable: true),
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    BuyerAddressLine = table.Column<string>(type: "text", nullable: true),
                    BuyerPostalCode = table.Column<string>(type: "text", nullable: true),
                    BuyerCity = table.Column<string>(type: "text", nullable: true),
                    BuyerCountry = table.Column<string>(type: "character varying(2)", maxLength: 2, nullable: false),
                    Description = table.Column<string>(type: "text", nullable: false),
                    NetAmountGr = table.Column<int>(type: "integer", nullable: false),
                    VatRatePct = table.Column<int>(type: "integer", nullable: false),
                    VatAmountGr = table.Column<int>(type: "integer", nullable: false),
                    GrossAmountGr = table.Column<int>(type: "integer", nullable: false),
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    GrantsMonths = table.Column<int>(type: "integer", nullable: false),
            ...
            migrationBuilder.CreateTable(
                name: "OrganizationCodeRedemptions",
                columns: table => new
                {
                    Id = table.Column<Guid>(type: "uuid", nullable: false),
                    OrganizationCodeId = table.Column<Guid>(type: "uuid", nullable: false),
                    OrganizationId = table.Column<Guid>(type: "uuid", nullable: false),
                    UserId = table.Column<Guid>(type: "uuid", nullable: false),
                    RedeemedAt = table.Column<DateTime>(type: "timestamp with time zone", nullable: false),
                    AccessUntil = table.Column<DateTime>(type: "timestamp with time zone", nullable: false),
                    CreatedAt = table.Column<DateTime>(type: "timestamp with time zone", nullable: false),
                    UpdatedAt = table.Column<DateTime>(type: "timestamp with time zone", nullable: false)
                },
                constraints: table =>
                {
                    table.PrimaryKey("PK_OrganizationCodeRedemptions", x => x.Id);
                    table.ForeignKey(
                        name: "FK_OrganizationCodeRedemptions_OrganizationCodes_OrganizationC~",
                        column: x => x.OrganizationCodeId,
                        principalTable: "OrganizationCodes",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Cascade);
                    table.ForeignKey(
                        name: "FK_OrganizationCodeRedemptions_Organizations_OrganizationId",
                        column: x => x.OrganizationId,
                        principalTable: "Organizations",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Cascade);
                    table.ForeignKey(
                        name: "FK_OrganizationCodeRedemptions_Users_UserId",
                        column: x => x.UserId,
                        principalTable: "Users",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Cascade);
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    StudentCodeAtAsk = table.Column<string>(type: "text", nullable: true),
                    ErrorContext = table.Column<string>(type: "text", nullable: true),
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_AiInteractions_Lessons_LessonId",
                        column: x => x.LessonId,
            ...
            migrationBuilder.CreateIndex(
                name: "IX_AiInteractions_LessonId",
            ...
            migrationBuilder.CreateIndex(
                name: "IX_OrganizationCodeRedemptions_OrganizationCodeId_UserId",
                table: "OrganizationCodeRedemptions",
                columns: new[] { "OrganizationCodeId", "UserId" },
                unique: true);

            migrationBuilder.CreateIndex(
                name: "IX_OrganizationCodeRedemptions_OrganizationId",
                table: "OrganizationCodeRedemptions",
                column: "OrganizationId");

            migrationBuilder.CreateIndex(
                name: "IX_OrganizationCodeRedemptions_UserId",
                table: "OrganizationCodeRedemptions",
                column: "UserId");

            migrationBuilder.CreateIndex(
                name: "IX_OrganizationCodes_Code",
