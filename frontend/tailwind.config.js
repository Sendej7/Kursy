  ...
  theme: {
    extend: {
      ...
      boxShadow: {
        ...
        'lift': '0 4px 6px -1px rgba(15, 23, 42, 0.05), 0 10px 24px -4px rgba(15, 23, 42, 0.08)',
        'glow': '0 0 0 1px rgba(99, 102, 241, 0.18), 0 8px 28px -4px rgba(99, 102, 241, 0.25)',
      },
      backgroundImage: {
        ...
        'radial-fade': 'radial-gradient(ellipse 80% 50% at 50% -20%, rgba(99,102,241,0.18), transparent 70%)',
      },
      animation: {
